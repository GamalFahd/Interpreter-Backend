...
public class NotebookExecutionContext {
    ...
    public NotebookExecutionContext(ByteArrayOutputStream outputStream, ByteArrayOutputStream errorsStream, Context context) {
